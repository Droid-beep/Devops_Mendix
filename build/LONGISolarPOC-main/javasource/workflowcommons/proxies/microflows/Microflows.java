...
public class Microflows
{
	...
	public static void aCT_Comment_ActivateEditMode(IContext context, workflowcommons.proxies.WorkflowComment _workflowComment, workflowcommons.proxies.WorkflowCommentHelper _workflowCommentHelper)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
	...
	public static void aCT_Comment_Revert(IContext context, workflowcommons.proxies.WorkflowCommentHelper _workflowCommentHelper, workflowcommons.proxies.WorkflowComment _workflowComment)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("WorkflowCommentHelper", _workflowCommentHelper == null ? null : _workflowCommentHelper.getMendixObject());
		params.put("WorkflowComment", _workflowComment == null ? null : _workflowComment.getMendixObject());
	...
	public static void aCT_WorkflowContext_Revert(IContext context, system.proxies.WorkflowContext _workflowContext)
	{
		...
		Core.microflowCall("WorkflowCommons.ACT_WorkflowContext_Revert").withParams(params).execute(context);
	}
	public static void aCT_WorkflowContext_Save(IContext context, system.proxies.WorkflowContext _workflowContext)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("WorkflowContext", _workflowContext == null ? null : _workflowContext.getMendixObject());
		Core.microflowCall("WorkflowCommons.ACT_WorkflowContext_Save").withParams(params).execute(context);
	}
	public static java.util.List<system.proxies.WorkflowUserTask> dS_Task(IContext context, workflowcommons.proxies.DashboardContext _dashboardContext)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("DashboardContext", _dashboardContext == null ? null : _dashboardContext.getMendixObject());
		java.util.List<IMendixObject> objs = Core.microflowCall("WorkflowCommons.DS_Task").withParams(params).execute(context);
	...
	public static java.util.List<system.proxies.WorkflowUserTask> dS_Task_AssignedToUser(IContext context, workflowcommons.proxies.DashboardContext _dashboardContext)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("DashboardContext", _dashboardContext == null ? null : _dashboardContext.getMendixObject());
		java.util.List<IMendixObject> objs = Core.microflowCall("WorkflowCommons.DS_Task_AssignedToUser").withParams(params).execute(context);
		java.util.List<system.proxies.WorkflowUserTask> result = null;
		if (objs != null)
		{
			result = new java.util.ArrayList<>();
	...
	public static java.util.List<system.proxies.WorkflowTaskDefinition> dS_TaskDefinition_Selectable_Administrator(IContext context, workflowcommons.proxies.DashboardContext _dashboardContext)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("DashboardContext", _dashboardContext == null ? null : _dashboardContext.getMendixObject());
		java.util.List<IMendixObject> objs = Core.microflowCall("WorkflowCommons.DS_TaskDefinition_Selectable_Administrator").withParams(params).execute(context);
	...
	public static java.util.List<system.proxies.WorkflowTaskDefinition> dS_TaskDefinition_Selectable_User(IContext context, workflowcommons.proxies.DashboardContext _dashboardContext)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("DashboardContext", _dashboardContext == null ? null : _dashboardContext.getMendixObject());
		java.util.List<IMendixObject> objs = Core.microflowCall("WorkflowCommons.DS_TaskDefinition_Selectable_User").withParams(params).execute(context);
		java.util.List<system.proxies.WorkflowTaskDefinition> result = null;
		if (objs != null)
		{
			result = new java.util.ArrayList<>();
	...
	public static java.util.List<workflowcommons.proxies.UserTaskTimeLine> dS_UserTaskTimeline(IContext context, system.proxies.WorkflowInstance _workflow)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("Workflow", _workflow == null ? null : _workflow.getMendixObject());
	...
	public static java.util.List<system.proxies.WorkflowInstance> dS_Workflow(IContext context, workflowcommons.proxies.DashboardContext _dashboardContext)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("DashboardContext", _dashboardContext == null ? null : _dashboardContext.getMendixObject());
	...
	public static java.util.List<system.proxies.WorkflowDefinition> dS_WorkflowDefinition_Selectable(IContext context, workflowcommons.proxies.DashboardContext _dashboardContext)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("DashboardContext", _dashboardContext == null ? null : _dashboardContext.getMendixObject());
	...
	public static void oCh_DashboardContext_UpdateTaskDashboard_2(IContext context, workflowcommons.proxies.DashboardContext _dashboardContext)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("DashboardContext", _dashboardContext == null ? null : _dashboardContext.getMendixObject());
		Core.microflowCall("WorkflowCommons.OCh_DashboardContext_UpdateTaskDashboard_2").withParams(params).execute(context);
	}
	...
	public static void sUB_TaskCount_Update(IContext context, workflowcommons.proxies.TaskCount _newTaskCount)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
	...
	public static java.math.BigDecimal sUB_UserTask_HandledOnTime(IContext context, java.util.Date _completedAfter, java.util.Date _completedBefore, system.proxies.User _user, java.lang.Long _userTask_CountCompleted, system.proxies.WorkflowDefinition _workflowDefinition_Selected, system.proxies.WorkflowTaskDefinition _taskDefinition_Selected)
	{
		...
		params.put("WorkflowDefinition_Selected", _workflowDefinition_Selected == null ? null : _workflowDefinition_Selected.getMendixObject());
		params.put("TaskDefinition_Selected", _taskDefinition_Selected == null ? null : _taskDefinition_Selected.getMendixObject());
		return (java.math.BigDecimal) Core.microflowCall("WorkflowCommons.SUB_UserTask_HandledOnTime").withParams(params).execute(context);
	}
